    ...
    data: {
      ...
      steps: { create: [
        ...
        { title: "Campaign Details", titleMs: "Butiran Kempen", titleZh: "广告详情", order: 1, fields: { create: [
          ...
          { label: "Advertise as", labelMs: "Iklankan sebagai", labelZh: "广告品牌", type: "DROPDOWN", required: true, order: 1, options: ["PropertyGuru", "iProperty", "PropertyGuru + iProperty"] },
          ...
          { label: "Call-to-action (CTA)", labelMs: "Seruan tindakan (CTA)", labelZh: "行动号召（CTA）", type: "DROPDOWN", required: true, order: 4, options: ["Contact Us", "Sign Up", "Book Now", "Get Offer", "Get Quote"] },
        ] } },
