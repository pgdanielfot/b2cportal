...
export const translations: Record<Language, Dictionary> = {
  en: {
    ...
    visualGuide: "Illustrative preview only. The final ad may vary across Meta placements, devices, and platform settings.",
  ...
  ms: {
    ...
    visualGuide: "Pratonton ini hanyalah ilustrasi. Paparan akhir mungkin berbeza mengikut penempatan Meta, peranti dan tetapan platform.",
  ...
  zh: {
    ...
    storyImage: "快拍图片",
    storyVideo: "快拍视频",
    visualGuide: "此预览仅供说明之用。最终广告可能因 Meta 广告位、设备和平台设置而有所不同。",
